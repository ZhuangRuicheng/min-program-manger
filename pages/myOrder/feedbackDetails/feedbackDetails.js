// pages/myOrder/feedbackDetails/feedbackDetails.js
const app = getApp()
  ...
  onLoad: function (options) {
    ...
    var successFunction = function (data) {
      that.setData({
        ...
        feedbackContent: JSON.parse(data.data.data.orderDetail.orderInfo).content,
        reply: JSON.parse(data.data.data.orderDetail.orderInfo).reply,
